<nav class="navbar navbar-expand my-navbar" style = "background: #1EA1F1; color: white;">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <!-- Nav Item - Messages -->
        <li class="nav-item">
{{--            <a href="{{route('admin.dashboard')}}" style = "font-size: 16px; color: white">Home</a>--}}
...
{{--            <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::user()->first_name }}</span>--}}
            <img class="img-profile rounded-circle" src="}">
              ...
              <button class="dropbtn" style = "color:black; background: #1EA1F1">

                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" style = "color:black;">
{{--                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::user()->first_name }}</span>--}}
                <img class="img-profile rounded-circle" src="{{ asset('assets/images/admin_logo.jpg') }}">

            </a>
            </button>
            <div class="dropdown-content">
                <a href="{{route('logout')}}" style = "font-size: 16px;">Logout</a>
                <!-- <a href="#">Link 2</a>
                <a href="#">Link 3</a> -->
            </div>
        </li>
