...
{{--    <a class="sidebar-brand" href="{{ route('admin.dashboard') }}"><span class="align-middle"> Dashboard </span></a>--}}
        <ul class="navbar-nav align-self-stretch">
            ...
            <!-- Start Section -->
{{--            <li class="">--}}
{{--                <a href = "{{route('')}}" class="nav-link text-left active"  role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-list"></i>  Home </a>--}}
{{--            </li>--}}
            <li class="has-sub">
                <a class="nav-link collapsed text-left" href="#collapseExample2" role="button" data-toggle="collapse" ><i class="flaticon-user"></i>  <i class = "fa fa-users"></i> View Items</a>
                                ...
                                <div class="col-lg-12 px-2">
                                    <div class="submenu-box">
                                        <ul class="list-unstyled m-0">
                                            <li><a href="{{ route('user_racks') }}"><i class = "fa fa-user"></i> &nbsp;Racks</a></li>
                                            <li><a href="{{ route('user_books') }}"><i class = "fa fa-user"></i> Books</a></li>
